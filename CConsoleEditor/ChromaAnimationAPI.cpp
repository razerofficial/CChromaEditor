...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B, FillColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B_NAME, FillColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillColorAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_R_G_B, FillColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_R_G_B_NAME, FillColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_COLOR_R_G_B_NAME_D, FillColorRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B, FillNonZeroColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, FillNonZeroColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillNonZeroColorAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B, FillNonZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B_NAME, FillNonZeroColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B_NAME_D, FillNonZeroColorRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B, FillThresholdColorsAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B_NAME, FillThresholdColorsAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B_NAME_D, FillThresholdColorsAllFramesRGBNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B, FillThresholdColorsMinMaxAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B_NAME, FillThresholdColorsMinMaxAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B_NAME_D, FillThresholdColorsMinMaxAllFramesRGBNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B, FillThresholdColorsMinMaxRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B_NAME, FillThresholdColorsMinMaxRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B_NAME_D, FillThresholdColorsMinMaxRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B, FillThresholdColorsRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B_NAME, FillThresholdColorsRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B_NAME_D, FillThresholdColorsRGBNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B, FillThresholdRGBColorsAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B_NAME, FillThresholdRGBColorsAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B_NAME_D, FillThresholdRGBColorsAllFramesRGBNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B, FillThresholdRGBColorsRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B_NAME, FillThresholdRGBColorsRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B_NAME_D, FillThresholdRGBColorsRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B, FillZeroColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, FillZeroColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillZeroColorAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_R_G_B, FillZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_R_G_B_NAME, FillZeroColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_ZERO_COLOR_R_G_B_NAME_D, FillZeroColorRGBNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET1_D_COLOR, Get1DColor);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET1_D_COLOR_NAME, Get1DColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET1_D_COLOR_NAME_D, Get1DColorNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET2_D_COLOR, Get2DColor);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET2_D_COLOR_NAME, Get2DColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET2_D_COLOR_NAME_D, Get2DColorNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET_R_G_B, GetRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_GET_R_G_B_D, GetRGBD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MAKE_BLANK_FRAMES_R_G_B, MakeBlankFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MAKE_BLANK_FRAMES_R_G_B_NAME, MakeBlankFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MAKE_BLANK_FRAMES_R_G_B_NAME_D, MakeBlankFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B, MultiplyIntensityAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B_NAME, MultiplyIntensityAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B_NAME_D, MultiplyIntensityAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_R_G_B, MultiplyIntensityRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_R_G_B_NAME, MultiplyIntensityRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_INTENSITY_R_G_B_NAME_D, MultiplyIntensityRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B, MultiplyNonZeroTargetColorLerpAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME, MultiplyNonZeroTargetColorLerpAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME_D, MultiplyNonZeroTargetColorLerpAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B, MultiplyTargetColorLerpAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME, MultiplyTargetColorLerpAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME_D, MultiplyTargetColorLerpAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET1_D_COLOR, Set1DColor);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET1_D_COLOR_NAME, Set1DColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET1_D_COLOR_NAME_D, Set1DColorNameD);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET2_D_COLOR, Set2DColor);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET2_D_COLOR_NAME, Set2DColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET2_D_COLOR_NAME_D, Set2DColorNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B, SetKeyColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeyColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B_NAME_D, SetKeyColorAllFramesRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_R_G_B, SetKeyColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_R_G_B_NAME, SetKeyColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_COLOR_R_G_B_NAME_D, SetKeyColorRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B, SetKeyNonZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B_NAME, SetKeyNonZeroColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B_NAME_D, SetKeyNonZeroColorRGBNameD);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_COLOR_ALL_FRAMES_R_G_B, SetKeysColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeysColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_COLOR_NAME, SetKeysColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_COLOR_R_G_B, SetKeysColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_COLOR_R_G_B_NAME, SetKeysColorRGBName);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_NON_ZERO_COLOR_R_G_B, SetKeysNonZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_NON_ZERO_COLOR_R_G_B_NAME, SetKeysNonZeroColorRGBName);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_ZERO_COLOR_ALL_FRAMES_R_G_B, SetKeysZeroColorAllFramesRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeysZeroColorAllFramesRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_ZERO_COLOR_NAME, SetKeysZeroColorName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_ZERO_COLOR_R_G_B, SetKeysZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEYS_ZERO_COLOR_R_G_B_NAME, SetKeysZeroColorRGBName);
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B, SetKeyZeroColorRGB);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B_NAME, SetKeyZeroColorRGBName);
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B_NAME_D, SetKeyZeroColorRGBNameD);
...
int ChromaAnimationAPI::InitAPI()
{
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B, FillColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B_NAME, FillColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillColorAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_R_G_B, FillColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_R_G_B_NAME, FillColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_COLOR_R_G_B_NAME_D, FillColorRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B, FillNonZeroColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, FillNonZeroColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillNonZeroColorAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B, FillNonZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B_NAME, FillNonZeroColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NON_ZERO_COLOR_R_G_B_NAME_D, FillNonZeroColorRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B, FillThresholdColorsAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B_NAME, FillThresholdColorsAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_ALL_FRAMES_R_G_B_NAME_D, FillThresholdColorsAllFramesRGBNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B, FillThresholdColorsMinMaxAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B_NAME, FillThresholdColorsMinMaxAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_ALL_FRAMES_R_G_B_NAME_D, FillThresholdColorsMinMaxAllFramesRGBNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B, FillThresholdColorsMinMaxRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B_NAME, FillThresholdColorsMinMaxRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_MIN_MAX_R_G_B_NAME_D, FillThresholdColorsMinMaxRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B, FillThresholdColorsRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B_NAME, FillThresholdColorsRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_COLORS_R_G_B_NAME_D, FillThresholdColorsRGBNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B, FillThresholdRGBColorsAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B_NAME, FillThresholdRGBColorsAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_ALL_FRAMES_R_G_B_NAME_D, FillThresholdRGBColorsAllFramesRGBNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B, FillThresholdRGBColorsRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B_NAME, FillThresholdRGBColorsRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_THRESHOLD_R_G_B_COLORS_R_G_B_NAME_D, FillThresholdRGBColorsRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B, FillZeroColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, FillZeroColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME_D, FillZeroColorAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_R_G_B, FillZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_R_G_B_NAME, FillZeroColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_ZERO_COLOR_R_G_B_NAME_D, FillZeroColorRGBNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET1_D_COLOR, Get1DColor);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET1_D_COLOR_NAME, Get1DColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET1_D_COLOR_NAME_D, Get1DColorNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET2_D_COLOR, Get2DColor);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET2_D_COLOR_NAME, Get2DColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET2_D_COLOR_NAME_D, Get2DColorNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET_R_G_B, GetRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_GET_R_G_B_D, GetRGBD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MAKE_BLANK_FRAMES_R_G_B, MakeBlankFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MAKE_BLANK_FRAMES_R_G_B_NAME, MakeBlankFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MAKE_BLANK_FRAMES_R_G_B_NAME_D, MakeBlankFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B, MultiplyIntensityAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B_NAME, MultiplyIntensityAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_ALL_FRAMES_R_G_B_NAME_D, MultiplyIntensityAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_R_G_B, MultiplyIntensityRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_R_G_B_NAME, MultiplyIntensityRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_INTENSITY_R_G_B_NAME_D, MultiplyIntensityRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B, MultiplyNonZeroTargetColorLerpAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME, MultiplyNonZeroTargetColorLerpAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_NON_ZERO_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME_D, MultiplyNonZeroTargetColorLerpAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B, MultiplyTargetColorLerpAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME, MultiplyTargetColorLerpAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_MULTIPLY_TARGET_COLOR_LERP_ALL_FRAMES_R_G_B_NAME_D, MultiplyTargetColorLerpAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET1_D_COLOR, Set1DColor);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET1_D_COLOR_NAME, Set1DColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET1_D_COLOR_NAME_D, Set1DColorNameD);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET2_D_COLOR, Set2DColor);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET2_D_COLOR_NAME, Set2DColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET2_D_COLOR_NAME_D, Set2DColorNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B, SetKeyColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeyColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_ALL_FRAMES_R_G_B_NAME_D, SetKeyColorAllFramesRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_R_G_B, SetKeyColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_R_G_B_NAME, SetKeyColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_COLOR_R_G_B_NAME_D, SetKeyColorRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B, SetKeyNonZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B_NAME, SetKeyNonZeroColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_NON_ZERO_COLOR_R_G_B_NAME_D, SetKeyNonZeroColorRGBNameD);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_COLOR_ALL_FRAMES_R_G_B, SetKeysColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeysColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_COLOR_NAME, SetKeysColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_COLOR_R_G_B, SetKeysColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_COLOR_R_G_B_NAME, SetKeysColorRGBName);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_NON_ZERO_COLOR_R_G_B, SetKeysNonZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_NON_ZERO_COLOR_R_G_B_NAME, SetKeysNonZeroColorRGBName);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_ZERO_COLOR_ALL_FRAMES_R_G_B, SetKeysZeroColorAllFramesRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_ZERO_COLOR_ALL_FRAMES_R_G_B_NAME, SetKeysZeroColorAllFramesRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_ZERO_COLOR_NAME, SetKeysZeroColorName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_ZERO_COLOR_R_G_B, SetKeysZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEYS_ZERO_COLOR_R_G_B_NAME, SetKeysZeroColorRGBName);
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B, SetKeyZeroColorRGB);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B_NAME, SetKeyZeroColorRGBName);
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SET_KEY_ZERO_COLOR_R_G_B_NAME_D, SetKeyZeroColorRGBNameD);
