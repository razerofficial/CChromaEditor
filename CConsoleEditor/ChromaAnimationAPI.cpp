...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_ADD_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES, AddNonZeroTargetAllKeysAllFrames)
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_ADD_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES_NAME, AddNonZeroTargetAllKeysAllFramesName)
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NONZERO_COLOR_ALL_FRAMES, FillNonZeroColorAllFrames)
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_FILL_NONZERO_COLOR_ALL_FRAMES_NAME, FillNonZeroColorAllFramesName)
...
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SUBTRACT_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES, SubtractNonZeroTargetAllKeysAllFrames)
CHROMASDK_DECLARE_METHOD_IMPL(PLUGIN_SUBTRACT_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES_NAME, SubtractNonZeroTargetAllKeysAllFramesName)
...
int ChromaAnimationAPI::InitAPI()
{
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_ADD_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES, AddNonZeroTargetAllKeysAllFrames)
	CHROMASDK_VALIDATE_METHOD(PLUGIN_ADD_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES_NAME, AddNonZeroTargetAllKeysAllFramesName)
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_FILL_NONZERO_COLOR_ALL_FRAMES, FillNonZeroColorAllFrames)
	...
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SUBTRACT_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES, SubtractNonZeroTargetAllKeysAllFrames)
	CHROMASDK_VALIDATE_METHOD(PLUGIN_SUBTRACT_NONZERO_TARGET_ALL_KEYS_ALL_FRAMES_NAME, SubtractNonZeroTargetAllKeysAllFramesName)
