...
/*
	...
	zero upon failure.
*/
typedef float		(*PLUGIN_GET_FRAME_DURATION_NAME)(const char* path, int frameId);
/*
	Get the frame colors and duration (in seconds) for a `Chroma` animation 
	...
	Returns the animation id upon success. Returns negative one upon failure.
*/
typedef int			(*PLUGIN_GET_FRAME_NAME)(const char* path, int frameId, float* duration, int* colors, int length, int* keys, int keysLength);
/*
...
/*
	...
	zero upon failure.
*/
typedef float		(*PLUGIN_GET_TOTAL_DURATION_NAME)(const char* path);
/*
...
*/
typedef void		(*PLUGIN_PREVIEW_FRAME_NAME)(const char* path, int frameId);
/*
...
/*
	...
	Returns the animation id upon success. Returns negative one upon failure.
*/
typedef int			(*PLUGIN_UPDATE_FRAME_NAME)(const char* path, int frameId, float duration, int* colors, int length, int* keys, int keysLength);
/*
